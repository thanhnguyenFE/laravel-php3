                ...
                <ul class="flex items-center justify-center gap-4 flex-wrap"
                    ...
                    <li class="me-2" role="presentation">
                        <button class="inline-block px-5 py-2.5 text-center me-2 mb-2"
                                ...
                                type="button" role="tab" aria-controls="profile" aria-selected="false">Tài khoản của tôi
                        </button>
                    </li>
                    <li class="me-2" role="presentation">
                        <button class="inline-block px-5 py-2.5 text-center me-2 mb-2"
                                id="dashboard-styled-tab" data-tabs-target="#styled-dashboard"
                                type="button" role="tab" aria-controls="dashboard" aria-selected="false">Lịch sử mua vé
                        </button>
                    </li>
                </ul>
            </div>
                ...
                <div class="hidden p-4 " id="styled-profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="mt-10">
                        <form method="post" action="{{route('client.update-profile')}}"
                              class="grid-cols-2 grid gap-10 mt-10" enctype="multipart/form-data">
                            @method('PUT')
                            @csrf
                            <div class="profile-pic">
                                ...
                                <img
                                    src="{{auth()->user()->avatar ? asset('storage/avatars/'.auth()->user()->avatar) : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBFIz1RbmXlp7G3mWuuDBjKCth7ZJJ_HjzCw&s'}}"
                                    id="output" width="200"/>
                            </div>
                            <div>
                                <div class="mb-6">
                                    <label for="name" class="block mb-2 text-sm font-medium text-white">Tên tài
                                        khoản</label>
                                ...
                                <div class="">
                                    <label for="email" class="block mb-2 text-sm font-medium text-white">Số điện
                                        thoại</label>
                                ...
                                <div class="mt-6" id="change_password" style="display: none">
                                    <div class="mb-6">
                                        <label for="password_old" class="block mb-2 text-sm font-medium text-white">Nhập
                                            mật khẩu cũ</label>
                                        <input name="password" type="password" id="password_old"
                                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                    </div>
                                    <div class="mb-6">
                                        <label for="password_new" class="block mb-2 text-sm font-medium text-white">Nhập
                                            mật khẩu mới</label>
                                        <input name="password_new" type="text" id="password_new"
                                               class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                                    </div>
                                    <div class="mb-6">
                                        <label for="enter_password_new"
                                               class="block mb-2 text-sm font-medium text-white">Nhập lại mật khẩu
                                            mới</label>
                                        <input name="enter_password_new" type="text" id="enter_password_new"
                            ...
                            dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700"
                                        type="button" id="button-change-password">
                                    Đổi mật khẩu
                                </button>
                ...
                <div class="hidden p-4" id="styled-dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                    <div class="mt-4 ring-1 ring-gray-700 sm:mx-0 sm:rounded-xl">
                        <table class="min-w-full divide-y divide-gray-600">
                            ...
                            <tr>
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Ngày
                                    giao dịch
                                </th>
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Tên phim
                                </th>
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Ngày
                                    chiếu
                                ...
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Giờ
                                    chiếu
                                </th>
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Phòng
                                </th>
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Số vé
                                </th>
                                <th scope="col"
                                    class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-white sm:pl-6">Tổng
                                    tiền
                                </th>
                            </tr>
                            </thead>
