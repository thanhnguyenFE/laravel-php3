...
@section('main-content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="d-flex align-items-center justify-content-between">
            <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Room /</span> {{$room->name}}</h4>
        ...
        <div class="mt-3">
            <a type="button" class="btn btn-outline-primary mr-3" href="{{route('rooms.edit', $room->id)}}">Edit</a>
